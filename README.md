...
| キー | 動作 |
|------|------|
| **↑ ↓** （上下矢印キー） | PDFやプレビューの上下スクロール |
| **Shift + ↑ ↓** （Shift＋上下矢印キー） | 左側のファイル一覧内で前後のファイルに移動（ループ対応） |
| **Shift + Enter** （Shift+Enterキー） | 現在選択中のファイル/フォルダを新しいタブで開く |
| **Escape** （Escキー） | モーダル（フォルダ選択・設定・ヘルプ）を閉じる |

### ホバーで表示される操作ヒント

- **左側ファイル一覧** にマウスを乗せると、ショートカット情報が表示されます
- **右側プレビューエリア** にマウスを乗せてファイルが表示中の場合、スクロール操作のヒントが表示されます
